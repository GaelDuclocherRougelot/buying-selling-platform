  ...
  const handleValidation = async (
    ...
    try {
      ...
      if (response.ok) {
        // Rafraîchir la liste
        await fetchProofs();
        alert(action === 'approve' ? 'Preuve approuvée !' : 'Preuve rejetée !');
      } else {
  ...
  if (loading) {
    return (
      <div className='container mx-auto p-6'>
        <h1 className='text-2xl font-bold mb-6'>Preuves d&apos;expédition</h1>
        ...
        <Card>
          <CardContent className='p-6'>
            <p className='text-center text-muted-foreground'>
              Aucune preuve d&apos;expédition en attente de validation.
            </p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className='flex justify-between items-start'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      {proof.payment.amount}€ - {proof.payment.buyer.username} →{' '}
              ...
              <CardContent>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <p>
                      <strong>Transporteur:</strong> {proof.carrier}
                    </p>
                    <p>
                      <strong>Numéro de suivi:</strong> {proof.trackingNumber}
                    </p>
                    <p>
                    ...
                    <div className='flex gap-2 mt-4'>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle>
                              Approuver la preuve d&apos;expédition
                            </AlertDialogTitle>
                            <AlertDialogDescription>
                              Cette action va :
                              <ul className='list-disc list-inside mt-2'>
                                <li>
                                  Capturer le paiement et le transférer au
                                  vendeur
                                </li>
                                <li>Marquer le produit comme vendu</li>
                                <li>Marquer la preuve comme approuvée</li>
                              </ul>
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              onClick={() =>
                                handleValidation(proof.id, 'approve')
                              }
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle>
                              Rejeter la preuve d&apos;expédition
                            </AlertDialogTitle>
                            <AlertDialogDescription>
                              Cette action va :
                              <ul className='list-disc list-inside mt-2'>
                                <li>Rembourser l&apos;acheteur</li>
                                <li>Remettre le produit en vente</li>
                                <li>Marquer la preuve comme rejetée</li>
                              </ul>
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              onClick={() =>
                                handleValidation(proof.id, 'reject')
                              }
