	...
	<main style={{ maxWidth: 800, margin: "0 auto", padding: "2rem" }}>
		...
		<section>
			...
			<p>
				...
				ventes réalisées sur notre plateforme. En passant commande, vous
				acceptez sans réserve les présentes CGV.
			</p>
		</section>
		<section>
			<h2>2. Commandes</h2>
			<p>
				...
				intégrale des présentes conditions. Les informations
				contractuelles seront confirmées par email après validation de
				la commande.
			</p>
		</section>
		<section>
			<h2>3. Prix</h2>
			<p>
				Les prix sont indiqués en euros, toutes taxes comprises. Nous
				nous réservons le droit de modifier les prix à tout moment, mais
				les produits seront facturés sur la base des tarifs en vigueur
		...
		<section>
			<h2>4. Livraison</h2>
			<p>
				Les produits sont livrés à l&apos;adresse indiquée lors de la
				commande. Les délais de livraison sont donnés à titre indicatif.
			</p>
		</section>
		<section>
		...
		<section>
			...
			<p>
				La responsabilité de la plateforme ne saurait être engagée en
